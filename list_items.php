...
// ตรวจสอบข้อผิดพลาดในการเชื่อมต่อหรือคำสั่ง SQL
if ($stmt === false) {
...
if (count($items) > 0) {
    var_dump($items); // เพิ่มบรรทัดนี้เพื่อตรวจสอบข้อมูลที่ถูกดึงมา
    foreach ($items as $item) {
        ...
        echo "<td class='border px-4 py-2'><img src='" . htmlspecialchars($item['image']) . "' width='100'></td>";
